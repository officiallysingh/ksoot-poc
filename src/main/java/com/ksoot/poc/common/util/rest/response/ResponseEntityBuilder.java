package com.ksoot.poc.common.util.rest.response;

import com.ksoot.poc.common.util.rest.response.builder.AbstractResponseBuilder;
import com.ksoot.poc.common.util.rest.response.builder.BodyBuilder;
import com.ksoot.poc.common.util.rest.response.builder.HeaderBuilder;
import com.ksoot.poc.common.util.rest.response.builder.StatusBuilder;
import java.net.URI;
